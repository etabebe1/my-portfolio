    ...
    <Transition>
      <div className="main-container">
        ...
        <div className="absolute flex h-full">
          ...
          {/* text content */}
          <div className="flex flex-col xl:flex-row justify-center w-full h-full gap-y-5 px-3 xl:px-28 md:px-24">
            <motion.div
                ...
                {aboutData[itemIndex].info.map((item, index) => {
                  return (
                    <div key={index}>
                      ...
                      {/* sub-title */}
                      <div className="subtitle flex gap-x-4 items-center justify-center z-20">
                        {item.icons &&
